          ...
          <nav className="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
              <div className="navbar-nav mx-auto">
                ...
                <NavLink className="nav-item nav-link">ABOUT US</NavLink>
                <NavLink className="nav-item nav-link">SERVICES</NavLink>
                <NavLink className="nav-item nav-link">PAGES</NavLink>
                <NavLink className="nav-item nav-link">CONTECT US</NavLink>
                <div className="nav-item dropdown">
                  <a href="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                  <div className="dropdown-menu m-0 bg-secondary rounded-0">
                    <NavLink className="dropdown-item">Products</NavLink>
                    <NavLink className="dropdown-item">Chackout</NavLink>
                    <NavLink className="dropdown-item">Testimonial</NavLink>
                    <NavLink  className="nav-item nav-link">Reviews</NavLink>
